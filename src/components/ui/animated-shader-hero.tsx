...
const useShaderBackground = () => {
    ...
    // Define defaultShaderSource locally or move outside if needed, 
    // ensuring it's available for WebGLRenderer.
    // Placing it here to capture the specific source used in the provided code.
...
void main(void) {
    ...
    class WebGLRenderer {
        ...
        // scale is used but TS might complain if not read
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10 animate-fade-in-up animation-delay-800">
                            {buttons.primary && (
                                <button
                                    ...
                                    className="cursor-pointer px-8 py-4 bg-gradient-to-r from-orange-500 to-yellow-500 hover:from-orange-600 hover:to-yellow-600 text-black rounded-full font-semibold text-lg transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-orange-500/25"
                                >
                            ...
                            {buttons.secondary && (
                                <button
                                    ...
                                    className="cursor-pointer px-8 py-4 bg-orange-500/10 hover:bg-orange-500/20 border border-orange-300/30 hover:border-orange-300/50 text-orange-100 rounded-full font-semibold text-lg transition-all duration-300 hover:scale-105 backdrop-blur-sm"
                                >
